...
public class ProviderTest {
    ...
    public void test2IdCalculated() throws Exception {
        Provider provider = new Provider();
        provider.setManagerDataSource(new ManagerDataSource() {
            @Override
    ...
    public void test3Processing() throws Exception {
        Provider provider = new Provider();
        provider.setManagerDataSource((idResume) -> {
    ...
    public void testGetResume() throws Exception {
        ...
        assertEquals("testName", provider.getManagerDataSource().getResume(idResume).getName());
        resumeOuter.setName("testName2");
        assertEquals("testName", provider.getResume(idResume).getName());
        assertEquals("testName2", provider.getManagerDataSource().getResume(idResume).getName());
    }
